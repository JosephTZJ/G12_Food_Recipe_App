...
public class SQLiteAdapter {
    ...
    public void removeShoppingList(String recipeTitle){
        // Define the WHERE clause to specify which row to delete
        String whereClause = RECIPE_TITLE + " = ?";
        String[] whereArgs = {recipeTitle};

        // Delete the row from the database
        sqLiteDatabase.delete(TABLE_SHOP_LIST, whereClause, whereArgs);
