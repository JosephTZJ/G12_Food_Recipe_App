...
public class DownloadedRecipeDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("entering downloadedrecipedetailsactivity " );
...
/*        if (recipeData != null) {
            recipe = parseRecipeFromJson(recipeData);
        }*/
        ...
        System.out.println("downloadrecipedetails title:" + title);
        System.out.println("downloadrecipedetails ingredients:" + ingredients);
        System.out.println("sdownloadrecipedetails steps:" + steps);
